    ...
    return (
        <>
            ...
            <div className="bg-end flex min-h-screen flex-col items-center bg-[url(images/cics1.png)] bg-[200px] bg-no-repeat p-6 lg:justify-center lg:p-8 bg-[#85B1C3]">
                <header className="fixed top-0 left-0 z-50 flex w-full justify-between bg-[#4076B4] p-1">
                    <div className="mx-auto w-full px-4 sm:px-6 lg:px-8 xl:px-12">
                        <div className="flex h-16 items-center justify-between lg:h-[72px]">
                            ...
                            <div className="flex items-center justify-end space-x-5">
                                <Link
                                    href={route('login')}
                                    className="inline-block rounded-sm border border-t-zinc-800 px-3 py-1 text-xl text-white bg-[#4076B4] hover:bg-[#305a8a] hover:border-white transition duration-200"
                                >
                                    Log in
                                </Link>
                                <Link
